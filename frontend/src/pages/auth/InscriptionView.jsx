...
const EyeIcon = ({ hidden }) =>
  hidden ? (
    <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9-4-10-7 0 0 1.21-2.42 3.42-4.42M9.88 9.88A3 3 0 0014.12 14.12M6.1 6.1L17.9 17.9M21 12s-4-7-9-7c-.73 0-1.44.08-2.12.23" />
    </svg>
  ) : (
    <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
const InscriptionView = ({
  ...
  const AvatarPreview = ({ small = false }) => (
    <div className={small ? "avatar-preview small" : "avatar-preview"}>
      <img className="dicebear-avatar-img" src={avatarUrl} alt="Avatar DiceBear" />
    </div>
  );

  return (
    <div className={`register-bg ${theme}`} dir={isArabic ? "rtl" : "ltr"}>
      <div className="stars">
      ...
      <div className="register-card">
        <div className="lang-switch">
          ...
          <button className={`lang-btn ${lang === "ar" ? "active" : ""}`} onClick={() => changeLang("ar")} type="button">AR</button>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-grid">
                  ...
                  <div className="avatar-choice-info">
                    ...
                    <div>
                      ...
                      <p className="avatar-choice-style">
                        {avatar.gender === "male" ? "Boy" : "Girl"} ·{" "}
                        {
                          avatarStylesByGender[avatar.gender].find(
                            (style) => style.value === avatar.style
                          )?.label
                        }
                      </p>
                    </div>
              ...
              <div>
                ...
                <input className="register-input" type="date" name="user_dob" value={form.user_dob} onChange={handleChange} required dir="ltr" />
              </div>
              ...
              <div>
                ...
                <select className="register-input register-select" name="grade" value={form.grade} onChange={handleChange} required>
              ...
              <div>
                ...
                <select className="register-input register-select" name="gouvernorat" value={form.gouvernorat} onChange={handleChange} required>
              ...
              <div className="avatar-controls">
                <div className="avatar-row">
                  ...
                  <div className="avatar-options">
                    {[
                      { value: "female", label: isArabic ? "بنت" : "Girl" },
                      { value: "male", label: isArabic ? "ولد" : "Boy" },
                    ].map((option) => (
                      <button
                        key={option.value}
                        type="button"
